    ...
    <React.Fragment>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          We would love to hear from you! Whether you have a question about our platform, need assistance with your project, or just want to share your feedback, our team is here to help.
          <br />
          <br />
